<template>
  <div>
    ...
    <el-dialog title="农家乐信息" v-model="fromVisible" width="50%" :close-on-click-modal="false" @closed="handleDialogClosed">
      <el-form :model="form" label-width="100px" style="padding-right: 30px" :rules="rules" ref="formRef">
        ...
        <el-form-item prop="img" label="图片">
          ...
          >
            <img v-if="form.img" :src="form.img" style="width: 100px; height: 100px">
            <el-icon v-else style="font-size: 50px; color: #8c939d; width: 100px; height: 100px; line-height: 100px; text-align: center; border: 1px dashed #d9d9d9;"><Plus /></el-icon>
          </el-upload>
        </el-form-item>
    ...
    <el-dialog title="农家乐信息" v-model="editorVisible" width="50%" :close-on-click-modal="false" destroy-on-close>
