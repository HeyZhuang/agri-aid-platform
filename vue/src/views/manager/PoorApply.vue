<template>
  <div>
      ...
      <el-table :data="tableData" stripe>
        ...
        <el-table-column prop="file" label="申请资料">
          <template v-slot="scope">
            <el-button type="warning" size="small" @click="downPoor(scope.row.file)">下载资料</el-button>
          </template>
        </el-table-column>
        ...
        <el-table-column label="操作" width="180" align="center">
          <template v-slot="scope">
            <el-button plain type="primary" size="small" :disabled="scope.row.status !== '待审核'" @click="check(scope.row)">审核</el-button>
          </template>
        </el-table-column>
      </el-table>
    ...
    <el-dialog title="贫困户审核" v-model="fromVisible" width="40%" :close-on-click-modal="false" destroy-on-close>
